...
| `scripts/validators/` | Deterministic single-file Node validators, pinned by frozen fixtures. | present in part — `gate-self-test.js` (#21), `cross-reference-integrity.js` (#19), `link-integrity.js` (#23), and `id-namespace-resolution.js` (#22), plus the check `registry.json`, landed (WP 5.1); the remaining seven WP 5.1 checks forthcoming |
