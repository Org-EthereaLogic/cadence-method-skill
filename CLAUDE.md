...
| `scripts/validators/` | Deterministic single-file Node validators, pinned by frozen fixtures. | present in part — `gate-self-test.js` (#21), `cross-reference-integrity.js` (#19), `link-integrity.js` (#23), `id-namespace-resolution.js` (#22), `evidence-tag-grammar.js` (#20), `loose-pointer-drift.js` (#24), and `manifest-registry-consistency.js` (#25), plus the validator registry `registry.json`, landed (WP 5.1); the remaining four WP 5.1 checks forthcoming |
...
| `fixtures/` | Frozen per-validator fixture packs. Retained, not scratch. | present in part — `fixtures/gate-self-test/` (#21), `fixtures/cross-reference-integrity/` (#19), `fixtures/link-integrity/` (#23), `fixtures/id-namespace-resolution/` (#22), `fixtures/evidence-tag-grammar/` (#20), `fixtures/loose-pointer-drift/` (#24), and `fixtures/manifest-registry-consistency/` (#25) landed (WP 5.1); remaining packs land with their checks; the local-CI parity runner is WP 5.2 (#31) |
