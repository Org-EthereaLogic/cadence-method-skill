...
| **Status** | v1.8 final — reconciled and ready for design-freeze review; build work other than WBS 5.0, which starts from the WP 1.3 validator spec sheet, and WBS 1.6, which is ungated, remains gated on signed WP 1.4 |
