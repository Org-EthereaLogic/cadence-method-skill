# Evidence Classes — CADENCE Method Reference (fixture-local copy)

> **Source of truth:** The CADENCE Method, v4.7 (final) — `docs/reference/source/CADENCE_METHOD.md`, Appendix A.
> **Status:** fixture-local copy of the seeded reference, hermetic within `fixtures/evidence-tag-grammar/`, so this pack runs without reaching outside its own fixture root. Everything from the appendix heading down is byte-identical to `skills/cadence-method/references/evidence-classes.md`.
